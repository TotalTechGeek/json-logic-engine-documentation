...
export default function Home() {
  ...
  return (
    <Layout title={`${siteConfig.title}`} description="Fast, Powerful &amp; Persistable Logic">
      
      <div>
        {/* center this guy and have it in the center */}
        <header>
          <br/>
          <h1 style={{ textAlign: 'center'}}>{siteConfig.title}</h1>
          <p style={{ textAlign: 'center'}}>{siteConfig.tagline}</p>

...
Additionally, it is important to note that this module supports context traversal of data within these control structures. 
...
<br />
This following example shows the context traversal, allowing `val` to ascend 2 scopes (map pushes 2 scopes, one for the iterator, one for the local context) - <br/>
